...
class HamburgerButton : UIButton {
    ...
    let outline: CGPath = {
        ...
        //        bezierPath.move(to:CGPoint(x: 124.5, y: 61.5))
        //        bezierPath.addCurve(to: CGPoint(x: 101.5, y: 61.5), control1: CGPoint(x: 104.5, y: 62.5), control2: CGPoint(x: 101.5, y: 61.5))
        //        bezierPath.addCurve(to: CGPoint(x: 86.5, y: 53.5), control1: CGPoint(x: 101.5, y: 61.5), control2: CGPoint(x: 91.5, y: 62.5))
        //      //  bezierPath.addCurve(to: CGPoint(x: 86.5, y: 30.5), control1: CGPoint(x: 81.5, y: 44.5), control2: CGPoint(x: 82.5, y: 34.5))
        //        bezierPath.addCurve(to: CGPoint(x: 101.5, y: 21.5), control1: CGPoint(x: 90.5, y: 26.5), control2: CGPoint(x: 93.5, y: 21.5))
        //        bezierPath.addCurve(to: CGPoint(x: 97.5, y: 44.5), control1: CGPoint(x: 109.5, y: 21.5), control2: CGPoint(x: 77.5, y: 44.5))
        //        bezierPath.addCurve(to: CGPoint(x: 124.5, y: 44.5), control1: CGPoint(x: 117.5, y: 44.5), control2: CGPoint(x: 124.5, y: 44.5))
